  ...
  <div>
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
      <b-form-group id="input-group-1" label="Title:" label-for="input-1">
        <b-form-input id="input-1" v-model="form.title" type="text" placeholder="Enter the title" required></b-form-input>
      </b-form-group>
      ...
      <b-button class="mr-2 mt-1" type="submit" variant="primary">Submit</b-button>
